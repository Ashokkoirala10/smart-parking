...
def show_slot_availability(request):
    ...
    if available_slots2.exists():
        ...
        time_free = Booking.objects.filter(selected_slot = "Slot-2").order_by("start_time")
        list_for_slot2 = []
        for booking in time_free:
            start_time = booking.start_time
            end_time = booking.end_time
    ...
    if available_slots3.exists():
        ...
        time_free = Booking.objects.filter(selected_slot = "Slot-3").order_by("start_time")
        list_for_slot3 = []
        for booking in time_free:
            start_time = booking.start_time
            end_time = booking.end_time
    ...
    if available_slots4.exists():
        ...
        time_free = Booking.objects.filter(selected_slot = "Slot-4").order_by("start_time")
        list_for_slot4 = []
        for booking in time_free:
            start_time = booking.start_time
            end_time = booking.end_time
